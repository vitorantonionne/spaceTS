...
function addCrewMember(member: string, spaceships: { name: string, crewLimit: number, crew: string[] }) {
...
function sendInMission(spaceships: { name: string, pilot: string, crew: string[], inMission: boolean , crewLimit: number}) {
